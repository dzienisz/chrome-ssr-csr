...
import type { PublicAnalysis as Analysis } from "@/lib/telemetry-schema";
      ...
      <Card className="bg-white">
        ...
        <div className="mt-6 flex items-center justify-center h-40">
          <Text className="text-gray-500">
            No analyses yet. Start using the extension!
          </Text>
        </div>
      </Card>
    );
    ...
    <>
      <Card className="bg-white">
              ...
              {data.map((analysis) => (
                ...
                >
                  ...
                  <td
                    ...
                    title={analysis.device_info?.country || undefined}
                  >
                    <span
                      className="text-base leading-none"
                      aria-label={analysis.device_info?.country || undefined}
                    >
                      {getFlag(analysis.device_info?.country) || (
                  ...
                  <td className="py-3 px-2">
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-medium rounded-md border ${getTypeStyle(analysis.render_type)}`}
                    >
                  ...
                  <td className="py-3 px-2">
                    <span
                      className={`text-sm font-semibold ${getConfidenceColor(analysis.confidence)}`}
                    >
                      {analysis.confidence}%
                    </span>
                  </td>
        ...
        <div className="mt-4 text-center">
          <Text className="text-xs text-gray-400">
            Click any row to view details · Scroll for more
          </Text>
        </div>
      </Card>
