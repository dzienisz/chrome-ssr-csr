...
import type { PublicAnalysis as AnalysisData } from "@/lib/telemetry-schema";
                      ...
                      {analysis.device_info?.country && (
                        <Text className="text-xs text-gray-500 mt-1">
                          {String.fromCodePoint(
                            0x1f1e6 +
                              analysis.device_info.country.charCodeAt(0) -
                              65,
                            0x1f1e6 +
                              analysis.device_info.country.charCodeAt(1) -
                              65,
                          )}{" "}
                          {analysis.device_info.country}
                        </Text>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span
                            className={`inline-flex px-2.5 py-1 text-sm font-semibold rounded-md border ${getTypeStyle(analysis.render_type)}`}
                          >
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex flex-wrap justify-end gap-1 mt-1">
                          {analysis.frameworks?.map((fw: string) => (
                            <Badge key={fw} size="xs" color="blue">
                              {fw}
                            </Badge>
                  ...
                  {analysis.hydration_stats && (
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 border border-orange-100 bg-orange-50 rounded-lg">
                        <Text className="text-xs font-bold text-orange-800 uppercase mb-2">
                          Hydration Health
                        </Text>
                        <div className="flex justify-between items-end">
                          <div>
                            <Text className="text-xs text-orange-600/80">
                              Score
                            </Text>
                            <Text className="text-xl font-bold text-orange-700">
                              {analysis.hydration_stats.score}
                            </Text>
                          </div>
                          <div className="text-right">
                            <Text className="text-xs text-orange-600/80">
                            ...
                            <Text className="text-lg font-medium text-orange-700">
                              {analysis.hydration_stats.errorCount}
                            </Text>
                          </div>
                        </div>
                      </div>
                      ...
                      {analysis.navigation_stats && (
                        <div className="p-3 border border-sky-100 bg-sky-50 rounded-lg">
                          <Text className="text-xs font-bold text-sky-800 uppercase mb-2">
                            Navigation (SPA)
                          </Text>
                          <div className="flex justify-between items-end">
                            <div>
                              <Text className="text-xs text-sky-600/80">
                                Type
                              </Text>
                              <Badge
                                size="xs"
                                color={
                                  analysis.navigation_stats.isSPA
                                    ? "blue"
                                    : "gray"
                                }
                              >
                            ...
                            <div className="text-right">
                              ...
                              <Text className="text-lg font-medium text-sky-700">
                                {analysis.navigation_stats.clientRoutes}
                              </Text>
                            </div>
                          </div>
                        </div>
                  ...
                  {analysis.tech_stack && (
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(analysis.tech_stack).map(
                          ([key, value]) => {
                            if (
                              !value ||
                            ...
                            return (
                              <div
                                key={key}
                                className="flex flex-col bg-white px-2 py-1 rounded border border-gray-200"
                              >
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="grid grid-cols-4 gap-2 text-center">
                        <div>
                          ...
                          <Text className="font-medium text-sm">
                            {analysis.core_web_vitals.lcp
                              ? `${analysis.core_web_vitals.lcp}ms`
                              : "-"}
                          </Text>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <Text className="font-medium text-sm">
                            {analysis.core_web_vitals.ttfb
                              ? `${analysis.core_web_vitals.ttfb}ms`
                              : "-"}
                          </Text>
                        </div>
                      </div>
